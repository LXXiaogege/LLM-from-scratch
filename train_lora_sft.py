# -*- coding: utf-8 -*-
"""
@Time ： 2025/3/22 14:00
@Auth ： 吕鑫
@File ：train_lora_sft.py
@IDE ：PyCharm
"""
...
def train_epoch(epoch, wandb):
    ...
    for step, (X, Y, loss_mask) in enumerate(train_loader):
        ...
        if (step + 1) % args.save_interval == 0 and (not ddp or dist.get_rank() == 0):
            model.eval()
            # 【区别1】只保存lora权重即可
            save_lora(model, f'{args.save_dir}/lora/{args.lora_name}_{lm_config.embedding_dim}.pth')
            model.train()
...
def init_model(lm_config):
    ...
    ckp = f'./out/rlhf_{lm_config.embedding_dim}{moe_path}.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/Users/lvxin/datasets/llm/lora_identity.jsonl")
