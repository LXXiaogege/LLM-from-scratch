...
def init_model(args):
    ...
    if args.load == 0:
        ...
        ckp = f'{args.out_dir}/{modes[args.model_mode]}_{args.embedding_dim}{moe_path}.pth'

        model = LLMModel(LMConfig(
...
def parse_args():
    ...
    parser.add_argument('--out_dir', default='/Users/lvxin/datasets/llm', type=str)
    parser.add_argument('--tokenizer', default='./models/tokenizer', type=str)
